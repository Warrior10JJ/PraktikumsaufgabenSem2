...
public:
    ...
    MainWidget(QMainWindow *parent = nullptr): QWidget(parent)
    {
        ...
        outputlabel2 = new QLabel();
        outputlabel2->setStyleSheet("background-color: black; color:green; font-size: 30px;font-weight: bold;border: 1px solid gray;");

        outputlabel3 = new QLabel();
        outputlabel3->setStyleSheet("background-color: black; color:green; font-size: 30px;font-weight: bold;border: 1px solid gray;");
